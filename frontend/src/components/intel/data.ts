...
export const SIM_MEMORIES: MemoryRecord[] = [
  ...
  { id: "m-20", kind: "recommendation", title: "Consolidate fulfilment vendors from 4 to 2", agent: "operations", createdAt: daysAgoIso(16), links: ["m-03", "m-14"], simulated: true, snippet: "Flux recommends consolidating fulfilment vendors from four to two. Modelled savings of Rs 340K/yr with a single-point-of-failure risk mitigated by dual-sourcing." },
  ...
  { id: "m-25", kind: "task", title: "Draft EU pilot success criteria", agent: "coordinator", createdAt: daysAgoIso(3, 9), links: ["m-01", "m-11", "m-18"], simulated: true, snippet: "Nexus drafting the EU pilot scorecard: 12 qualified logos, sub-Rs 40K CAC, and one lighthouse case study within 90 days — the bar for scaling investment." },
];
...
export const SIM_EVENTS: TimelineEvent[] = [
  { id: "ev-01", kind: "decision", title: "EU market entry pilot approved", summary: "90-day DACH pilot green-lit with a Rs 38K CAC ceiling and a 12-logo success bar.", createdAt: daysAgoIso(2, 3), agents: ["strategy", "finance", "coordinator"], link: "/reports" },
  ...
  { id: "ev-15", kind: "decision", title: "Fulfilment vendor consolidation", summary: "Four vendors to two; Rs 340K/yr modelled savings with dual-sourcing mitigation.", createdAt: daysAgoIso(34), agents: ["operations", "finance"], link: "/agents/operations" },
...
export const FEED_SCRIPT: FeedItem[] = [
  ...
  { id: "f-03", kind: "opportunity", agent: "strategy", body: "Partner-sourced deals close 31% faster than outbound. Doubling the enablement budget could pull Rs 1.2M of pipeline into this fiscal year.", confidence: 68 },
  ...
  { id: "f-22", kind: "opportunity", agent: "legal", body: "Completing SOC 2 Type II unblocks an estimated Rs 2.8M of stalled enterprise pipeline based on the last five security reviews.", confidence: 76 },
