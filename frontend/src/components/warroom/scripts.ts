...
const EU_EXPANSION: DeliberationScript = {
  ...
  verdict: {
    recommendation:
      "Proceed with a phased EU entry: land in Ireland and the Netherlands in Q2 with a two-person GTM pod, cap incremental burn at Rs 40K/mo, and gate the wider rollout on 25 qualified pipeline accounts and completed GDPR readiness by end of Q3.",
    confidence: 81,
  },
  turns: [
    {
    ...
    },
    {
      ...
      text: "The numbers make me nervous. A credible EU launch costs Rs 55–70K a month fully loaded — entity setup, two hires, localized billing. That takes runway from 19 months to roughly 14. Doable, but it eats the buffer we hold for a downturn. I am at caution until someone shows me a cheaper wedge.",
      stance: "caution",
      confidence: 62,
      evidence: ["Q3-Financial-Model.xlsx", "Runway 19.2 mo", "Burn Rs 210K/mo"],
    },
    {
      speaker: "strategy",
      phase: "positions",
    ...
    },
    {
      ...
      text: "Atlas, sequencing discipline is exactly what worries me — our track record on phased rollouts is that they un-phase themselves. The Q2 partner program was scoped at Rs 20K and closed at Rs 47K. If we go, I want a hard monthly cap with an automatic pause trigger, not a plan that assumes restraint.",
      stance: "caution",
      confidence: 66,
    ...
    },
    {
      ...
      text: "Fair hit, Ledger. So let's design for it: a two-person GTM pod, no entity until we clear 25 qualified accounts, billing through our existing merchant-of-record. That structure caps exposure near Rs 40K a month and gives you a kill switch at the Q3 gate. The strategic upside survives; the blank check does not.",
      stance: "support",
      confidence: 82,
    ...
    },
    {
      ...
      text: "I can absorb the residency work — it is about six engineer-weeks and it dovetails with the storage refactor already on the Q1 board. What I cannot absorb silently is support. One EU-timezone support hire, roughly Rs 6K a month, and my objection collapses. Cheaper than a missed-SLA churn spiral.",
      stance: "support",
      confidence: 74,
    ...
    },
    {
      ...
      text: "With the pod structure, merchant-of-record billing, and a hard Rs 40K monthly cap, the model holds: runway stays above 16 months in the base case and the Q3 gate protects the downside. Scout's cost-of-delay estimate tips it. I am moving to support — conditional on the cap being enforced in the budget, not the slide deck.",
      stance: "support",
      confidence: 77,
...
const PRICING_CHANGE: DeliberationScript = {
  ...
  turns: [
    ...
    },
    {
      ...
      text: "The math is compelling. At current volumes a 20% Pro increase adds roughly Rs 31K MRR. Even in my bearish band — 6% incremental churn — we net positive within two months. Our gross margin on Pro is 84%, so nearly all of it drops through. Strong support from me.",
      stance: "support",
      confidence: 85,
      evidence: ["Pricing-Elasticity-Model.xlsx", "MRR +Rs 31K est.", "Gross margin 84%"],
    },
    {
      speaker: "research",
      phase: "positions",
    ...
    },
    {
      ...
      text: "Scout, deferring one quarter costs roughly Rs 93K in foregone revenue. For that price, the promo-war risk has to be worth more than Rs 93K of expected churn — which requires believing a fifth of our Pro base is shopping competitors this quarter. Retention data says under 4% even open competitor emails. I do not buy it.",
      stance: "support",
      confidence: 83,
    ...
    },
    {
      ...
      text: "The grandfathered version keeps about 70% of the upside — roughly Rs 22K MRR in year one, ramping to full value as the base renews. Slower, but the risk profile is dramatically better and the rollback trigger makes it reversible. I endorse Atlas's structure over my original blanket increase.",
      stance: "support",
      confidence: 81,
