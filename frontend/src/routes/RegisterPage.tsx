...
export function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen bg-white font-sans selection:bg-[#6C5CE7] selection:text-white">
      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-gray-50 p-12 lg:flex border-r border-gray-100">
        ...
        <div className="relative z-10">
          <h2 className="mb-4 text-4xl font-bold text-gray-900 leading-tight">
            Build your <br /> executive team.
          </h2>
          <p className="text-lg text-gray-500 max-w-md">
            Deploy specialized AI agents that understand your business, crunch your data, and automate your strategy.
          </p>
        </div>
        ...
        <div className="relative z-10 -ml-12 -mb-24 mt-12 overflow-hidden rounded-tr-3xl border border-gray-200 bg-white shadow-2xl shadow-[#6C5CE7]/10 p-8">
            <div className="mb-6 flex items-center gap-4 border-b border-gray-100 pb-4">
               <div className="h-10 w-10 rounded-full bg-[#6C5CE7]/20" />
               <div>
                  <div className="mb-2 h-4 w-32 rounded bg-gray-100 animate-pulse" />
            ...
            <div className="grid grid-cols-2 gap-4">
               ...
               <div className="h-24 rounded-xl border border-gray-100 bg-gray-50/50 p-4">
                 <div className="mb-2 h-4 w-16 rounded bg-gray-200" />
                 <div className="h-6 w-24 rounded bg-purple-500/20" />
               </div>
            </div>
        </div>
      </div>
      ...
      <div className="flex w-full flex-col justify-center px-8 sm:px-16 lg:w-1/2 xl:px-32 py-12">
        <motion.div
        ...
        >
          <div className="mb-8">
            <h1 className="mb-2 text-3xl font-bold tracking-tight text-gray-900">Create an account</h1>
            <p className="text-gray-500">Start your free trial today. No credit card required.</p>
          </div>
          ...
          <div className="mb-6 flex items-center justify-center gap-4">
            ...
            <span className="text-xs font-medium uppercase text-gray-400">Or register with email</span>
            <div className="h-px flex-1 bg-gray-200" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="full_name" className="mb-1.5 block text-sm font-medium text-gray-700">Full name</label>
                <input
                  id="full_name"
                  required
              ...
              <div>
                <label htmlFor="organization_name" className="mb-1.5 block text-sm font-medium text-gray-700">Company</label>
                <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-[#6C5CE7] px-4 py-3.5 text-sm font-bold text-white shadow-md shadow-[#6C5CE7]/20 transition-all hover:bg-[#5a4cdb] hover:shadow-lg hover:shadow-[#6C5CE7]/30 active:scale-[0.98] disabled:opacity-70"
            >
              {loading ? (
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            ...
            <Link to="/login" className="font-semibold text-[#6C5CE7] hover:text-[#5a4cdb]">
              Sign in
            </Link>
          </p>
        </motion.div>
