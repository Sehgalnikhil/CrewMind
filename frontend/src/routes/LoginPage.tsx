    ...
    <div className="flex min-h-screen items-center justify-center bg-surface px-4">
      ...
      >
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-slate-400">Sign in to your executive workspace</p>
        </div>
        ...
        <Card>
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <Button type="submit" loading={loading} icon={<LogIn className="h-4 w-4" />} className="mt-2">
              Sign in
            </Button>
          </form>
        </Card>
        ...
        <p className="mt-6 text-center text-sm text-slate-400">
          ...
          <Link to="/register" className="font-medium text-crew-400 hover:text-crew-300">
            Create one
          </Link>
        </p>
      </motion.div>
